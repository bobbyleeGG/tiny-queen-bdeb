...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tiny-queen-bdeb
```

A live public deployment of this template is available at [https://tiny-queen-bdeb.templates.workers.dev](https://tiny-queen-bdeb.templates.workers.dev)
